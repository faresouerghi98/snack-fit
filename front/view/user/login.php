<?php
    ...
    define('BASE_URLA',"http://www.localhost/snack-fit/back/");
    ...
    if(isset($_POST['username']) && isset($_POST['password'])){
            $User=new UserCore();
            $cond= array('username' => $_POST['username'],'password'=>$_POST['password']);
            $user=$User->login($cond);
            if(empty($user)){
                header ('location: login.php');
            }else{
                if($user->role=='admin'){
                    $_SESSION['admin'] = $user;
                    header ('location: '.BASE_URLA.'view/home.php');
                    die();
                }else{
                    $_SESSION['user'] = $user;
                            ...
                            <form action="#" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-3">
                                        <input type="text" class="form-control" id="company" placeholder="username" value="" name="username">
                                    </div>
                                    <div class="col-12 mb-3">
                                        <input type="password" class="form-control" id="email" placeholder="password" value="" name="password">
                                    </div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <!-- Popper js -->
    <script src="<?= WR_URL?>js/popper.min.js"></script>
    <!-- Bootstrap js -->
    <script src="<?= WR_URL?>js/bootstrap.min.js"></script>
    <!-- Plugins js -->
    <script src="<?= WR_URL?>js/plugins.js"></script>
    <!-- Active js -->
    <script src="<?= WR_URL?>js/active.js"></script>
